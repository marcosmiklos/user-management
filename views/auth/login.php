        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <?=
                    Html::submitButton(
                            UserManagementModule::t('front', 'Login'), ['class' => 'btn btn-lg btn-primary btn-block']
                    )
                    ?>
                    <br>
                    <?=
                    Html::a('Recuperar Senha', ['auth/password-recovery'], ['class' => 'btn btn-default btn-block']
                    )
                    ?>
